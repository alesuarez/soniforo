...
uint8_t RNDIS_Host_ConfigurePipes(
		USB_ClassInfo_RNDIS_Host_t* const RNDISInterfaceInfo,
		uint16_t ConfigDescriptorSize, void* DeviceConfigDescriptor)
 ...
 */
uint8_t RNDIS_Host_SendKeepAlive(
		USB_ClassInfo_RNDIS_Host_t* const RNDISInterfaceInfo)
 ...
 */
uint8_t RNDIS_Host_InitializeDevice(
		USB_ClassInfo_RNDIS_Host_t* const RNDISInterfaceInfo)
ATTR_NON_NULL_PTR_ARG(1);
...
uint8_t RNDIS_Host_SetRNDISProperty(
		USB_ClassInfo_RNDIS_Host_t* const RNDISInterfaceInfo,
		const uint32_t Oid, void* Buffer, const uint16_t Length)
ATTR_NON_NULL_PTR_ARG(1) ATTR_NON_NULL_PTR_ARG(3);
...
uint8_t RNDIS_Host_QueryRNDISProperty(
		USB_ClassInfo_RNDIS_Host_t* const RNDISInterfaceInfo,
		const uint32_t Oid, void* Buffer, const uint16_t MaxLength)
ATTR_NON_NULL_PTR_ARG(1) ATTR_NON_NULL_PTR_ARG(3);
 ...
 */
bool RNDIS_Host_IsPacketReceived(
		USB_ClassInfo_RNDIS_Host_t* const RNDISInterfaceInfo)
ATTR_NON_NULL_PTR_ARG(1);
...
uint8_t RNDIS_Host_ReadPacket(
		USB_ClassInfo_RNDIS_Host_t* const RNDISInterfaceInfo, void* Buffer,
 ...
 *	@return	Nothing
 */
static inline void RNDIS_Host_USBTask(
		USB_ClassInfo_RNDIS_Host_t* const RNDISInterfaceInfo)
